...
\begin{enumerate}
  ...
  \item \TODO{Derive Lorentz transform of $x$ via Michelson-Morley (thought) experiment.}

  \item \TODO{Derive Lorentz time dilation (at a fixed location) via spaceship clock.}

  \item \TODO{Derive Lorentz transform of $t$ at different locations via back-front spaceship clocks.}

  \item \TODO{Can I show that relativistic mass formula fits the bill?}
