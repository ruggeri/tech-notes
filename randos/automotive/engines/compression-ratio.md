...
- Limits to compression include knock, but also as you compress gas
  ...
  is always better.
- Efficiency of Otto cycle is `1 - 1/(compression_ratio ^ (gamma-1))`,
...
- Sources:
  - https://www.youtube.com/watch?v=nveqCMNTth0 early basic
    Engineering Explained video on compression ratio. Basically just
    defines it and describes knock as the limit to compression ratio.
  - https://www.youtube.com/watch?v=t4yh5Pt8was slightly more advanced
