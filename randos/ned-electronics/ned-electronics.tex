...
A next question: what is the \define{voltage drop} across a thermionic
...
Thermionic diodes are \define{non-Ohmic}. The current is controlled by
...
The \define{triode} is an amplifying vacuum tube. The screen acts just
