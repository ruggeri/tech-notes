...
- Computer Science
  ...
  - Mutual exclusion: MCS and CLH spinlocks. I think people put
    themselves in some kind of queue as they wait?
  - Hazard pointers: they have something to do with ABA problem and also
    garbage collection?
  - Hardware transactional memory:
    - Intel had TSX but it is often disabled now?
...
- Maybe explore lower-level CUDA programming or GPU architecture.
  - Especially: what does CUDA have that ROCm doesn't? Is CUDA the
    secret sauce that makes nVIDIA more valuable than ATI?
- Gyroscopes?
