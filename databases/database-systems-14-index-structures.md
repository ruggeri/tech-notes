...
- I believe notes on extensible hashing and linear hashing are
  duplicated in a file called "hash-map-tricks.md".
...
- One defect of this strategy is that you don't just want the average
  size to be small; you want the _worst_ size to fit in a block. So
