...
\begin{equation*}
  \begin{split}
    ...
    ={}&
      2 \mtxA'_{i, j}(0) \Big(
        -4 \left( \cos^2  - \sin^2 0 \right) \mtxA_{i, j}
      \Big) \\
    ={}&
      2 \mtxA_{i, j} \left( -4 \mtxA_{i, j} \right) \\
    ={}&
      -8 \left( \mtxA_{i, j} \right)^2
  \end{split}
\end{equation*}
...
\begin{enumerate}
  ...
  \item We were unsure if the minimum of $f$ in the space is actually
  zero.
...
we know from the cancelation of the $\mtxA_{k, i}, \mtx_{k, j}$ terms.
